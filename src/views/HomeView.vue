<template>
    <div class="flex justify-center pb-8">
        <div class="w-full flex items-start gap-8 px-8">
            <!-- Sidebar -->
            <aside class="w-64 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 z-10">
...
function goToVideo(id: number) {
    router.push({ name: 'video', params: { id: id - 1 } })
}
</script>
